...
<?php endif; ?>
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="header text-uppercase"><?php echo lang('menu_cms'); ?></li>

                        <li class="treeview <?=active_link_controller('posts')?>">
                            <a href="#">
                                <i class="fa fa-pencil"></i>
                                <span><?php echo lang('menu_posts'); ?></span>
                                <i class="fa fa-angle-left pull-right"></i>
                            </a>
                            <ul class="treeview-menu">
                                <li class="<?=active_link_controller('posts')?>">
                                    <a href="<?php echo site_url('admin/posts'); ?>">
                                        <span><?php echo lang('menu_posts_all'); ?></span>
                                    </a>
                                </li>
                                <li class="<?=active_link_controller('posts')?>">
                                    <a href="<?php echo site_url('admin/posts/create'); ?>">
                                        <span><?php echo lang('menu_posts_add'); ?></span>
                                    </a>
                                </li>
                                <li class="<?=active_link_controller('posts')?>">
                        ...
                        <li class="<?=active_link_controller('services')?>">
                            <a href="<?php echo site_url('admin/services'); ?>">
                                <i class="fa fa-handshake-o"></i> <span><?php echo lang('menu_services'); ?></span>
                            </a>
                        </li>
                        <li class="<?=active_link_controller('gallery')?>">
                            <a href="<?php echo site_url('admin/gallery'); ?>">
                                <i class="fa fa-picture-o"></i> <span><?php echo lang('menu_gallery'); ?></span>
                            </a>
                        </li>
                        <li class="<?=active_link_controller('clients')?>">
                            <a href="<?php echo site_url('admin/clients'); ?>">
                                <i class="fa fa-briefcase "></i> <span><?php echo lang('menu_clients'); ?></span>
                            </a>
                        </li>
                        <li class="<?=active_link_controller('contact')?>">
                            <a href="<?php echo site_url('admin/contact'); ?>">
                                <i class="fa fa-volume-control-phone "></i> <span><?php echo lang('menu_contact'); ?></span>
                            </a>
                        </li>
                        ...
                        <li class="treeview <?=active_link_controller('prefs')?>">
                            ...
                            <ul class="treeview-menu">
                                <li class="<?=active_link_function('interfaces')?>">
                                    <a href="<?php echo site_url('admin/prefs/interfaces/admin'); ?>">
