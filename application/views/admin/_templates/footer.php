...
?>
            ...
            <footer class="main-footer">
                ...
                <strong><?php echo lang('footer_copyright'); ?> &copy; 2014-<?php echo date('Y'); ?> <a href="http://odostore.in" target="_blank">ODOSTORE.IN</a>.</strong> <?php echo lang('footer_all_rights_reserved'); ?>.
            </footer>
        </div>
...
<?php endif; ?>
        ...
        <script src="<?php echo base_url($frameworks_dir . '/odostore/js/dp.min.js'); ?>"></script>
        <script src="<?php echo base_url($plugins_dir .'/ckeditor/ckeditor.js'); ?>"></script>
        <script src="<?php echo base_url($plugins_dir .'/ckfinder/ckfinder.js'); ?>"></script>
